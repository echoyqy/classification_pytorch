...
def parse_args():
    ...
    parser.add_argument('--data-path', default='D:\\cv\\data\\transform-data3', help='dataset')
    ...
    parser.add_argument('--resume', default='d:\\cv\\vemcv\\model\\transfer_model\\classification\\checkpoint3.pth',
